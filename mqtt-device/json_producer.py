...
from model.drone_battery_sensor import Drone_battery_sensor
...
broker_ip = "127.0.0.1"
broker_port = 1883
default_topic = "device/{}/battery".format(device_id)
message_limit = 1000
...
battery_sensor = Drone_battery_sensor()
...
for message_id in range(message_limit):
    battery_sensor.measure_battery()
    payload_string = MessageDescriptor(int(time.time()),
                                       "BATTERY_SENSOR",
                                       battery_sensor.battery).to_json()
