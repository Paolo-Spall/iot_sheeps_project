...
class FlockCenterResource(Resource):
    ...
    def get(self):
        ...
        device_telemetry_data = self.data_manager.get_flock_data()
    ...
    def post(self):
        try:
            ...
            self.data_manager.add_flock_telemetry_data(telemetry_data_dict)
