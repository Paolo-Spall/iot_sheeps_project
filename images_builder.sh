...
sudo docker run --name=http-inventory-api-lab --network iot_network -p 7070:7070 -v ${PWD}/target_web_conf.yaml:/app/conf.yaml --restart always -d http_iot_inventory_api-lab:0.1
